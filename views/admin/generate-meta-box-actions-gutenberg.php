...
<div class="wpzinc-option">
	<div class="full">
		...
		<span class="test">
			<a href="<?php echo admin_url( 'edit.php?post_type=' . $this->base->get_class( 'post_type' )->post_type_name . '&' . $this->base->plugin->name . '-action=test&id=' . $group_id . '&type=' . $this->settings['group_type'] ); // phpcs:ignore ?>" class="button button-primary"><?php esc_html_e( 'Test', 'page-generator' ); ?></a>
		</span>

		<span class="generate">
			<a href="<?php echo admin_url( 'admin.php?page=' . $this->base->plugin->name . '-generate&id=' . $group_id . '&type=' . $this->settings['group_type'] ); // phpcs:ignore ?>" class="button button-primary"><?php esc_html_e( 'Generate via Browser', 'page-generator' ); ?></a>
		</span>
	</div>
</div>
<?php
