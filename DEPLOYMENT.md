...
- Generate the `languages/page-generator.pot` file
...
- In `page-generator.php`, change the Version header to the new version number.
- In `page-generator.php`, change the `PLUGIN_VERSION` constant to the new version number.
...
[Create a New Release](https://github.com/n7studios/page-generator/releases/new), completing the following:
...
The release will also be available to view on the [Releases](https://github.com/n7studios/page-generator/releases) section of this GitHub repository.